...
class HtmlReporterTest {
    ...
    void testConvertToJson() {
        AnalysisData data = new AnalysisData(
                ...
                true, "test_utils.py", 80, false, false, Collections.emptyList(), Collections.emptyMap()); // testability
    ...
    void testConvertToHierarchyJson() {
        AnalysisData data1 = new AnalysisData(
                ...
                true, "server_test.go", 75, false, false, Collections.emptyList(), Collections.emptyMap());
        AnalysisData data2 = new AnalysisData(
                ...
                false, "", 20, false, false, Collections.emptyList(), Collections.emptyMap());
